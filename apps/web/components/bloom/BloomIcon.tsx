...
/**
 * Inline SVG icon set ported from the Bloom prototype (24px viewbox, ~1.6px
 * stroke). Used for habit "seed" icons and Bloom UI affordances.
 */
const PATHS: Record<string, ReactElement> = {
    ...
    cloud: <path d="M6 18 a4 4 0 0 1 0 -8 a5 5 0 0 1 10 1 a3 3 0 0 1 0 7 z" />,
    bell: (
        <>
...
export default function BloomIcon({
    name,
    size = 20,
    stroke = "currentColor",
    fill = "none",
